...
export const ROUTES = {
  ...
  ASSET_TYPE_VERSION: `/assetType/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  ASSET_OVERVIEW: '/assets/overview',
  DATA_ASSETS: '/assets/data',
  DATA_ASSET_DETAILS: `/dataAsset/${PLACEHOLDER_ROUTE_FQN}`,
  DATA_ASSET_VERSION: `/dataAsset/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
